              ...
              <div className="absolute bottom-4 right-4 flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="relative">
                  <button 
                    ...
                    className="bg-white/90 backdrop-blur-sm p-1.5 rounded-full text-gray-700 hover:bg-white"
                  >
                  ...
                  {/* Dropdown menu */}
                  {showMenu === index && (
                    <div className="absolute bottom-full right-0 mb-2 w-36 bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
